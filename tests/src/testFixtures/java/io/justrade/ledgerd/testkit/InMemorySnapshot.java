...
public final class InMemorySnapshot {
    ...
    private final io.justrade.ledgerd.protocol.MessageHeaderDecoder headerDecoder =
    ...
    public void corruptFirstBalanceValue() {
        ...
        while (offset < length) {
            ...
            if (headerDecoder.templateId() == io.justrade.ledgerd.protocol.BalanceEntryDecoder.TEMPLATE_ID) {
                final int balanceValueIndex = bodyOffset
                        + io.justrade.ledgerd.protocol.MessageHeaderDecoder.ENCODED_LENGTH
