...
import io.justrade.ledgerd.pipeline.EventJournalStreams;
import io.justrade.ledgerd.protocol.AllowanceChangedEventDecoder;
import io.justrade.ledgerd.protocol.BalanceChangedEventDecoder;
import io.justrade.ledgerd.protocol.CapturedEventDecoder;
import io.justrade.ledgerd.protocol.CommandRejectedEventDecoder;
import io.justrade.ledgerd.protocol.MessageHeaderDecoder;
import io.justrade.ledgerd.protocol.ReleasedEventDecoder;
import io.justrade.ledgerd.protocol.ReservedEventDecoder;
 ...
 * LEDGERD message ({@code MessageHeader} + event body) with no consensus framing.
 *
