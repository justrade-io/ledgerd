 ...
 *                         Falls back to LEDGERD_ARCHIVE_CHANNEL.
 *   LEDGERD_ARCHIVE_CHANNEL  single Archive control channel
...
public final class RiskServiceLauncher {
    ...
    public static void main(final String[] args) {
        ...
        final int httpPort = Integer.parseInt(envOrDefault("LEDGERD_HTTP_PORT", "8090"));
        ...
        try (EventJournalFollower follower = new EventJournalFollower(journalBuilder.build(), service);
            ...
            LOG.log(
                    ...
                    "LEDGERD risk service started: httpPort={0} archiveChannels={1}",
                    http.port(),
                    channels);
            parkUntilShutdown("ledgerd-risk-shutdown");
        }
    }
