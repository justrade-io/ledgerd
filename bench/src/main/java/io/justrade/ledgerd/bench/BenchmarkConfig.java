 ...
 * sensible defaults; the LEDGERD ingress endpoints also fall back to the
 * {@code LEDGERD_INGRESS_ENDPOINTS} environment variable so the harness can drive an
...
public final class BenchmarkConfig {
    ...
    private final String ledgerdEndpoints;
    ...
    private BenchmarkConfig(
        ...
        this.ledgerdEndpoints = ledgerdEndpoints;
    ...
    public static BenchmarkConfig fromArgs(final String[] args) {
        ...
        int[] mix = {40, 30, 30};
        List<String> backends = List.of("ledgerd", "postgres", "redis");
        ...
        final String envEndpoints = System.getenv("LEDGERD_INGRESS_ENDPOINTS");
        final String ledgerdEndpoints = envEndpoints == null || envEndpoints.isBlank() ? null : envEndpoints;
    ...
    public String ledgerdEndpoints() {
        return ledgerdEndpoints;
    }
